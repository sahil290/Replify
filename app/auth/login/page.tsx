  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-white px-4 py-16">
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-lg p-10">
        ...
        <h1 className="font-display text-2xl text-center text-gray-900 mb-1">Welcome back</h1>
        <p className="text-sm text-center text-gray-400 mb-8">Sign in to your workspace</p>
        ...
        <button
          ...
          className="btn-ghost w-full justify-center gap-2 !py-2.5"
        >
